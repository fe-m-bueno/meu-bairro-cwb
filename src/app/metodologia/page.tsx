...
export default function MetodologiaPage() {
        ...
        <div className="space-y-12 text-sm leading-relaxed text-zinc-300">
          ...
          <section id="introducao">
            ...
            <p>
              ...
              usando dados públicos reais. Cada bairro recebe um índice geral de
              0 a 100 composto por sete categorias temáticas, calculadas a
              partir de equipamentos urbanos oficiais disponibilizados pelo
              IPPUC / GeoCuritiba.
            </p>
            <p className="mt-3">
  ...
  (diversidade × 0,07)`}
          ...
          <section id="educacao">
            ...
            <p className="mb-4">
              Mede a proximidade a escolas municipais e CMEIs (educação
              infantil). O score é a média simples dos três fatores.
            </p>
            <ThresholdTable
              rows={[
                {
          ...
          <section id="transporte">
            ...
            <p className="mb-4">
              Mede o acesso ao transporte público — paradas, terminais e
              variedade de linhas.
            </p>
            <ThresholdTable
              rows={[
